...
var mydef = {
    ...
    "container": {
        ...
        "title": "Conditional",
        "attributes": {"abstractionId":"conditional","class":"com.sinfonier.bolts.Conditional"},
        "description": "Operación condicional para elegir entre dos posibles salidas.",
        "fields": [
            {"type": "string", "name": "field", "wirable": false,"label":"Field" },
            {"type": "select", "name": "operator", "wirable": false,
              label: "Operator",
              "cdata": true,
             "choices": [ ">",">=","<","<=","==","!=","RegexExpression"]
            },
            {"type": "string", "name": "value", "wirable": true,"label":"Value",
                "ddConfig": {
                    "type": "field",
